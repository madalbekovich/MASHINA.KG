...
class PassengerCarsLISTSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PassengerCars
        fields = (
            'id', 'mark', 'model', 'manufacturing_year', 'body', 'generation', 'engine', 'drive', 'gearbox', 'wheel',
            'modification', 'video_youtube', 'images', 'videos', 'govern_number', 'add_info', 'passengers_cars_desc',
